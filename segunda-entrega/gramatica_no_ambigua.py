...
def run(random_mode = False):
  g = Grammar()
  # si random es True, se genera un numero aleatorio entre 1 y 100
  size = random.randint(1, 100) if random_mode else int(input("Ingrese el número de reglas de la cadena: "))
  balanced = g.generate_string_balanced(size)
